    ...
    with open(archivo_unificado, 'w', encoding='utf-8') as sql_unificado:
        ...
        for archivo_csv in archivos_csv:
            ...
            try:
                ...
                # También guardar archivo individual por CSV
